...
#       https://github.com/gradle/gradle/blob/master/subprojects/plugins/src/main/resources/org/gradle/api/internal/plugins/unix/gradlew.template
...
if "$cygwin" || "$msys" ; then
    ...
    for arg do
        ...
        # unlike a while loop, we don't need to bother saving the current
        # value of $set to use in the next iteration.
        set -- "$arg" "$@"
        shift
    done
fi
